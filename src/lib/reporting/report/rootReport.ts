...
export class RootReport extends CompositeReport {
    ...
    public printStatistics() {
        ...
        this.logger.info(`${this.numberOfSuccessfulTests}/${this.numberOfTests} passed. ${numberOfFailedTests} failed. ${this.numberOfSkippedTests} skipped.`);
        this.logger.info(`Total duration: ${Math.round(this.duration) / 1000} s`);
    }
}